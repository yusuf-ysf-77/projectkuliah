...
export default function UniversalMessagePage() {
  ...
  return (
    <div className="flex h-full rounded-2xl border border-white/6 bg-[#16162a] overflow-hidden shadow-lg">
      {/* Contact sidebar */}
      <div
        className={cn(
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-[10px] text-white/40">
                  {chatContacts.length} conversations
                </p>
              </div>
      ...
      >
        {selectedUser && selectedUserObj ? (
          <>
            ...
            {/* Messages with external scrollbar */}
            <ExternalScroll
          ...
          <div className="flex-1 flex items-center justify-center">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 mt-6 text-xs text-white/30">
                ...
                <span>{chatContacts.length} contacts</span>
              </div>
            </motion.div>
          </div>
        )}
