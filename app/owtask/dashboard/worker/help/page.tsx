...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: "How do I view my assigned tasks?",
        a: "Go to 'My Tasks' from the sidebar. You'll see all tasks assigned to you, organized in Kanban or list view. Filter by status or division to find specific tasks.",
      },
      {
        q: "How do I submit my work?",
        a: "Open a task detail page. Use the 'Submit Your Work' form at the bottom. You can add text description and attach files. Click 'Submit Work' when ready.",
      },
      {
        q: "How do I change task status as a worker?",
        a: "As a worker, you can't directly change task status. Submit your work and your leader will review and update the status. You can track status changes in the timeline.",
      },
      {
        q: "Can I set reminders for my tasks?",
        a: "Yes! You can add events to your personal calendar with reminders. Go to Calendar and create a deadline or plan event for your task.",
      },
      {
        q: "How do I view task details and leader info?",
        a: "Click on any task to open its detail page. You'll see the task description, deadline, priority, leader info, team members, and your submission status.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "How do I communicate with my leader?",
        a: "Go to Messages from the sidebar. Select your leader from the contact list to start or continue a conversation. You can also use task-specific chats.",
      },
      {
      ...
      },
      {
        ...
        a: "Each task has its own chat channel. Open a task and click the Chat button to discuss that specific task with your leader and teammates.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: "Click 'New Event' or click on any date in the month view. Choose the event type and fill in the details. You can set personal reminders and plans.",
      },
      {
        q: "Can I view my tasks on the calendar?",
        a: "Yes! Your assigned task deadlines automatically appear on the calendar. Click on any task to open its detail page.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Go to Profile from the sidebar. Click 'Save Changes' after updating your information. You can edit your name, phone, location, and bio.",
      },
      {
        q: "How do I change my password?",
        a: "Go to Settings > Security. Enter your current password, then your new password twice. Click 'Update Password' to save.",
      },
      {
        q: "Can I change my role?",
        a: "Only leaders can change roles. Contact your team leader if you need a role change.",
      },
    ],
  },
  {
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-violet-100 text-sm mt-0.5">
              Learn how to use owTask effectively
            </p>
          </div>
        </div>
      </div>
