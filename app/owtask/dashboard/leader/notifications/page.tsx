...
const mockNotifications: Notification[] = [
  {
    ...
    description: "Budi submitted work for 'Landing Page'",
    time: "2 min ago",
    group: "today",
    read: false,
  },
  {
    ...
    description: "Sari completed 'Desain UI Dashboard v2'",
    time: "10 min ago",
    group: "today",
    read: false,
  },
  {
    ...
    description: "Maya mentioned you in 'Sprint Planning': @Andi please review",
    time: "15 min ago",
    group: "today",
    read: false,
  },
  {
    ...
    type: "chat",
    title: "New message",
    description: "Farhan: Laporan progress minggu ini sudah selesai",
    time: "1 hour ago",
    group: "today",
    read: false,
  },
  ...
  },
  {
    ...
    description: "You approved Maya's work on 'Video Tutorial'",
    time: "3 hours ago",
    group: "today",
    read: true,
  },
  ...
  },
  {
    ...
    type: "task",
    title: "Task overdue",
    description: "Video Tutorial is now overdue",
    time: "2 days ago",
    group: "earlier",
    read: true,
  },
    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-violet-100 text-sm mt-0.5">
              Stay updated on team activity and submissions
            </p>
          </div>
          {unreadCount > 0 && (
            <Button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          {
            label: "Submissions",
            value: notifications.filter((n) => n.type === "submission").length,
            icon: FileText,
            color: "text-purple-400",
            bg: "bg-purple-500/10",
          },
