    ...
    questions: [
      {
        ...
        a: "Click the 'New Task' button on the Tasks page. Fill in the title, description, select assignees from your team, set deadline and priority. You can also attach files and set division.",
      },
      {
        q: "Can I assign tasks to multiple workers?",
        a: "Yes! When creating or editing a task, you can select multiple assignees. Tasks can be set as 'Individual' or 'Group' type for different collaboration needs.",
      },
      {
        q: "How do I change task status?",
        a: "Click on a task to open its details. Use the status dropdown to change between Pending, In Progress, Completed, or Overdue. You can also review worker submissions here.",
      },
      {
        q: "How do I review submissions?",
        a: "Open a task detail page. Scroll to the Submissions section to see all worker submissions. You can approve, reject, or request revisions for each submission.",
      },
      {
        q: "How do I set task priority?",
        a: "When creating a task, use the Priority dropdown to set Low, Medium, High, or Urgent priority levels. High priority tasks are highlighted in the dashboard.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: "Go to Settings > Team and click 'Invite Member'. Share the invite link or enter their email directly. New members will receive an invitation to join.",
      },
      {
        q: "How do I assign workers to tasks?",
        a: "When creating or editing a task, you'll see a list of all workers in your team. Select one or more workers to assign them to the task.",
      },
      {
        q: "Can I see my team's performance?",
        a: "Yes! The Leader Dashboard shows team performance charts including completion rates, productivity trends, and individual worker statistics in the Team panel.",
      },
      {
        q: "How do I manage team divisions?",
        a: "Go to Settings > Team to manage divisions. You can create new divisions, assign workers to divisions, and filter tasks by division.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "How does the leader messaging work?",
        a: "As a leader, you can message any team member across all divisions. Select a contact from the sidebar to start or continue a conversation.",
      },
      {
      ...
      },
      {
        ...
        a: "Each task has its own chat channel. Open a task and click the Chat button to discuss that specific task with assigned workers.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        q: "Can I view team tasks on the calendar?",
        a: "Yes! All your team's task deadlines automatically appear on the calendar alongside your events. Click on any task to open its detail page.",
      },
      {
        q: "How do I schedule team meetings?",
        a: "Create a new event with type 'Meeting'. Set the date, add a description with meeting details, and it will appear for all team members.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: "Go to the Notes page and click 'New Note'. Add a title, content, choose a color, and add tags for organization.",
      },
      {
        q: "Can I share notes with my team?",
        a: "Notes are currently personal. Shared notes feature is coming soon in a future update.",
      },
    ],
  },
];
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-violet-100 text-sm mt-0.5">
              Manage your team effectively with owTask
            </p>
          </div>
        </div>
      </div>
