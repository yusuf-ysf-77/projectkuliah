            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                <h2 className="font-bold text-white flex items-center gap-2">
                  Messages
                  <Badge className="bg-violet-500/15 text-violet-400 border-0 text-[9px] px-1.5 py-0.5 rounded-md">
                    <Shield className="h-2.5 w-2.5 mr-0.5" /> Leader
                  </Badge>
                </h2>
        ...
        {selectedUser && selectedUserObj ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">Pesan Tim</h3>
              <p className="text-sm text-white/40 max-w-xs">
                Sebagai leader, kamu bisa mengirim pesan ke semua anggota tim.
              </p>
